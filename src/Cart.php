...
namespace Shobhnath\Shoppingcart;
...
use Shobhnath\Shoppingcart\Exceptions\UnknownModelException;
use Shobhnath\Shoppingcart\Exceptions\InvalidRowIDException;
use Shobhnath\Shoppingcart\Exceptions\CartAlreadyStoredException;
...
class Cart
{
     ...
     * @param array     $options
     * @param float     $taxrate
     * @return \Shobhnath\Shoppingcart\CartItem
     */
